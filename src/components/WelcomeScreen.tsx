    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-warm-cream to-background">
      ...
      <div className="relative z-20 flex flex-col items-center justify-end min-h-screen px-6 py-8 pb-16 text-center">
        ...
        <div className="mb-8 animate-fade-in">
          ...
          {/* Marketplace Subtitle Message */}
          <div className="bg-card/60 backdrop-blur-md rounded-2xl px-4 py-2.5 mx-4 border border-border/30 shadow-xs">
            <p className="text-xs text-foreground/80 font-medium text-center leading-relaxed">
              Find your ideal pet companion or easily rehome your pet directly with caring adopters.
            </p>
          </div>
        </div>
